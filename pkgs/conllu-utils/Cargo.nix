...
rec {
  ...
  rootCrate = rec {
    packageId = "conllu-utils 0.1.3 (path+file:///Users/daniel/git/conllu-utils)";
  ...
  internal = rec {
    ...
    crates = {
      ...
      "conllu 0.2.0 (registry+https://github.com/rust-lang/crates.io-index)" = rec {
        crateName = "conllu";
        version = "0.2.0";
        edition = "2018";
      ...
      "conllu-utils 0.1.3 (path+file:///Users/daniel/git/conllu-utils)" = rec {
        ...
        dependencies = [
          ...
          {
            name = "conllu";
            packageId = "conllu 0.2.0 (registry+https://github.com/rust-lang/crates.io-index)";
          }
          {
            name = "flate2";
