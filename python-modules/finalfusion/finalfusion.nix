...
# finalfusion-python-0.4.0
    ...
    features_.finalfusion_python."0.4.0" = deps: f: updateFeatures f (rec {
      ...
      (cratesIO.features_.failure."${deps."finalfusion_python"."0.4.0"."failure"}" deps)
      (cratesIO.features_.finalfusion."${deps."finalfusion_python"."0.4.0"."finalfusion"}" deps)
      (cratesIO.features_.libc."${deps."finalfusion_python"."0.4.0"."libc"}" deps)
      (cratesIO.features_.ndarray."${deps."finalfusion_python"."0.4.0"."ndarray"}" deps)
      (cratesIO.features_.numpy."${deps."finalfusion_python"."0.4.0"."numpy"}" deps)
      (cratesIO.features_.pyo3."${deps."finalfusion_python"."0.4.0"."pyo3"}" deps)
      (cratesIO.features_.toml."${deps."finalfusion_python"."0.4.0"."toml"}" deps)
    ];
